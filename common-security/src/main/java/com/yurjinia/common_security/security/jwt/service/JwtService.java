package com.yurjinia.common_security.security.jwt.service;


import com.yurjinia.common_security.exception.CommonException;
import com.yurjinia.common_security.exception.ErrorCode;
import com.yurjinia.common_security.security.jwt.constants.JwtConstants;
import com.yurjinia.common_security.security.jwt.dto.JwtToken;
...
public class JwtService {
   ...
   // @Value("${jwt.token.key}")
    private String secretKey = "HvkjjOh2pmc28YGIQzCTFXCfGT6JLBhcwmx1oSJyeXE=";

    //@Value("${jwt.token.expiration}")
    private long expirationInSeconds = 36000;
